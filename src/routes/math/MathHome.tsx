...
import { ChevronLeft, Settings, Plus, PenLine, Shapes, Clock, X } from 'lucide-react'

const modes = [
  { to: '/math/addition', icon: Plus, label: '더하기', desc: '덧셈과 뼉셈 연습', gradient: 'bg-gradient-to-br from-blue-500 to-indigo-600', iconColor: 'text-white' },
