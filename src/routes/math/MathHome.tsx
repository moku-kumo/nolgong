...
import { ChevronLeft, Settings, Plus, Minus, PenLine, Shapes, Clock, X, PencilLine } from 'lucide-react'

const modes = [
{ to: '/math/addition', icon: Plus, label: '더하기', desc: '덧셈 연습', gradient: 'bg-gradient-to-br from-blue-500 to-indigo-600', iconColor: 'text-white' },
  { to: '/math/subtraction', icon: Minus, label: '빼기', desc: '뺄셈 연습', gradient: 'bg-gradient-to-br from-rose-500 to-pink-600', iconColor: 'text-white' },
  { to: '/math/multiplication', icon: X, label: '곱하기', desc: '구구단 연습', gradient: 'bg-gradient-to-br from-purple-500 to-pink-600', iconColor: 'text-white' },
  { to: '/math/number-writing', icon: PencilLine, label: '숫자 쓰기', desc: '0부터 9까지 따라 써요', gradient: 'bg-gradient-to-br from-cyan-500 to-blue-600', iconColor: 'text-white' },
  ...
  { to: '/math/clock', icon: Clock, label: '시계 보기', desc: '시계를 보고 시간을 맞춰요', gradient: 'bg-gradient-to-br from-amber-500 to-orange-600', iconColor: 'text-white' },
]
